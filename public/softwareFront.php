	...
	<div class="navbar navbar-default navbar-fixed-top">
  		...
  		<div class="container">
    		...
    		<div class="collapse navbar-collapse">
  				...
  				<ul class="nav navbar-nav">
    				...
    				<li> <a href="softwareFront.php"><span class="glyphicon glyphicon-home large" aria-hidden="true" style="color:#F11C1C;"></span></a></li>
		...
		<div id="topContainer2">
	  		...
	  		<div id="componentPalette">
				...
				<a class="btn btn-secondary comBtns" href="scheduler.php">ShedYule</a>
				
				<a class="btn btn-secondary comBtns" href="waitingList.php">Warteliste</a>
						
				<a class="btn btn-secondary comBtns" href="patientNotes.php">PatientNotes</a>
						
				<a class="btn btn-secondary comBtns" href="invoiceX.php">InvoiceX</a>
				
				<a class="btn btn-secondary comBtns" href="email.php">Email List</a>
				
				<a class="btn btn-secondary comBtns" href="stats.php">ReportGen</a>
